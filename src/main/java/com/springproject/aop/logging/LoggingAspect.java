package com.springproject.aop.logging;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.springproject.aop.dao.PassengerDaoImpl.getPassenger(..))")
    public void before(JoinPoint joinPoint) {
        Object[] methodArgs = joinPoint.getArgs();
        LOGGER.info("Input to Method :" + joinPoint.getSignature().getName() + " with args :" + methodArgs[0]);
    }

    @After("execution(* com.springproject.aop.dao.PassengerDaoImpl.getPassenger(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.springproject.aop.dao.*.*(..))", returning="val")
    ...
    @AfterThrowing(pointcut = "execution(* com.springproject.aop.dao.*.*(..))",
            throwing="exception")
